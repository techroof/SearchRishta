...
public class MutualFragmentRecyclerViewAdapter extends RecyclerView.Adapter<MutualFragmentRecyclerViewAdapter.ViewAdapter> {
    ...
    public MutualFragmentRecyclerViewAdapter(ArrayList<Users> UserlistData, Context context, DasboardClickListener listener) {
    ...
    @NonNull
    @Override
    public MutualFragmentRecyclerViewAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MutualFragmentRecyclerViewAdapter.ViewAdapter holder, int position) {
