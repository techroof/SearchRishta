...
public class PhysicalStatusAdapter extends RecyclerView.Adapter<PhysicalStatusAdapter.ViewHolder> {

    private Context context;
    private List<String> attributeNameArrayList;
    private int selectedItem;
    public String physicalStatus="null";

    public PhysicalStatusAdapter(Context context, List<String> attributeNameArrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull PhysicalStatusAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                physicalStatus=attributeNameArrayList.get(selectedItem);
