...
public class MaritalStatusAttributeAdapter extends RecyclerView.Adapter<MaritalStatusAttributeAdapter.ViewHolder> {
    ...
    public MaritalStatusAttributeAdapter(Context context, List<String> attributeNameArrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull MaritalStatusAttributeAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                maritalStatus=attributeNameArrayList.get(selectedItem);
