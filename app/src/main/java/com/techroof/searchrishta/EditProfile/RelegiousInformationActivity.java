...
public class RelegiousInformationActivity extends AppCompatActivity {

    TextInputLayout etRelegion, etRelegiousValues, etRelegiousSect;
    Button btnEditRelegiousValues;
    FirebaseFirestore firestore;
    FirebaseAuth firebaseAuth;
    String relegion, relegiousValues, relegionSectIslam, relegionSectHindu, relegionSectChristian, relegiousSect, uId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relegious_information);
        ...
        etRelegion.getEditText().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(RelegiousInformationActivity.this).setTitle("Select Your Relegious Information")
        ...
        etRelegiousValues.getEditText().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(RelegiousInformationActivity.this).setTitle("Select Your Relegious Values")
        ...
        etRelegiousSect.getEditText().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (relegion == null) {
                    ...
                    new AlertDialog.Builder(RelegiousInformationActivity.this).setTitle("Select Your Sect")
    ...
    private void UpdateRelegiousValues(String Relegion, String RelegiousSect, String RelegiousValues) {
        ...
        firestore.collection("users").document(uId).set(userbasicDetailprefMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
        ...
        firestore.collection("users").document(uId).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isComplete()) {
                    ...
                    relegiousValues = task.getResult().getString("religiousValue");
