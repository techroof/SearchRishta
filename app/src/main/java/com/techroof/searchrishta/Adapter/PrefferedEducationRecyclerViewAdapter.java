...
public class PrefferedEducationRecyclerViewAdapter extends RecyclerView.Adapter<PrefferedEducationRecyclerViewAdapter.ViewAdapter> {
    ...
    public PrefferedEducationRecyclerViewAdapter(ArrayList<Users> UserlistData, Context context, DasboardClickListener listener, ArrayList<String> storedId) {
    ...
    @NonNull
    @Override
    public PrefferedEducationRecyclerViewAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PrefferedEducationRecyclerViewAdapter.ViewAdapter holder, int position) {
