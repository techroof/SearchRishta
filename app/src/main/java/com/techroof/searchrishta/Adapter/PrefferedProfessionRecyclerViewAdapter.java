...
public class PrefferedProfessionRecyclerViewAdapter extends RecyclerView.Adapter<PrefferedProfessionRecyclerViewAdapter.ViewAdapter> {
    ...
    public PrefferedProfessionRecyclerViewAdapter(ArrayList<Users> UserlistData, Context context, DasboardClickListener listener, ArrayList<String> storedId) {
    ...
    @NonNull
    @Override
    public PrefferedProfessionRecyclerViewAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PrefferedProfessionRecyclerViewAdapter.ViewAdapter holder, int position) {
