...
public class ProfileCreatorAttributesAdapter extends RecyclerView.Adapter<ProfileCreatorAttributesAdapter.ViewHolder> {

    private Context context;
    private List<String> attributeNameArrayList;
    private int selectedItem;
    public String profileCreator = "null";

    public ProfileCreatorAttributesAdapter(Context context, List<String> attributeNameArrayList) {
    ...
    @Override
    public void onBindViewHolder(final ProfileCreatorAttributesAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                profileCreator = attributeNameArrayList.get(selectedItem);
