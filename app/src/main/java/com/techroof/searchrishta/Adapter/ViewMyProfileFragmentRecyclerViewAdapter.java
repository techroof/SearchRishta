...
public class ViewMyProfileFragmentRecyclerViewAdapter extends RecyclerView.Adapter<ViewMyProfileFragmentRecyclerViewAdapter.ViewAdapter> {
    ...
    public ViewMyProfileFragmentRecyclerViewAdapter(ArrayList<Users> UserlistData, Context context, DasboardClickListener listener) {
    ...
    @NonNull
    @Override
    public ViewMyProfileFragmentRecyclerViewAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ViewMyProfileFragmentRecyclerViewAdapter.ViewAdapter holder, int position) {
