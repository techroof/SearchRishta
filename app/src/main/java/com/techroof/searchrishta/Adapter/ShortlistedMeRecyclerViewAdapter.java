...
public class ShortlistedMeRecyclerViewAdapter extends RecyclerView.Adapter<ShortlistedMeRecyclerViewAdapter.ViewAdapter> {
    ...
    public ShortlistedMeRecyclerViewAdapter(ArrayList<Users> UserlistData, Context context, DasboardClickListener listener) {
    ...
    @NonNull
    @Override
    public ShortlistedMeRecyclerViewAdapter.ViewAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ShortlistedMeRecyclerViewAdapter.ViewAdapter holder, int position) {
