...
public class Upgrade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAccountnumber = findViewById(R.id.tv_acccount_number);
        tvBankname = findViewById(R.id.tv_bank_name);
        tvAccounntname = findViewById(R.id.account_name);
        btnSubmitdetails = findViewById(R.id.btn_submit_details);
        ...
        firestore.collection("users").whereEqualTo("userId",uId)
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if (activationStatus.equals("normal")) {
                    ...
                    if (context != null) {
                        new AlertDialog.Builder(Upgrade.this).setTitle("Upgrade to our Premium account ").
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            task.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "URI" + proofImg, Toast.LENGTH_SHORT).show();
                                }
                            });
