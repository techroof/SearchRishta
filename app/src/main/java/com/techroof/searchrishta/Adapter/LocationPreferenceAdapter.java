...
public class LocationPreferenceAdapter extends RecyclerView.Adapter<LocationPreferenceAdapter.ViewHolder> {
    ...
    public LocationPreferenceAdapter(Context context, List<String> attributeNameArrayList, ClickListener listener) {
    ...
    @Override
    public void onBindViewHolder(final LocationPreferenceAdapter.ViewHolder holder, int position) {
